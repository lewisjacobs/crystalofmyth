...
public class TrackingStateFilter
{
    ...
    private KinectMSWrapper.NuiTransformSmoothParameters smoothParameters;
    ...
    {
        this.smoothParameters = new KinectMSWrapper.NuiTransformSmoothParameters();
    ...
    public void Init(KinectMSWrapper.NuiTransformSmoothParameters smoothingParameters)
    {
    ...
    public void Reset()
    {
        this.history = new FilterDoubleExponentialData[(int)KinectMSWrapper.NuiSkeletonPositionIndex.Count];
    }

    // Update the filter with a new frame of data and smooth.
    public void UpdateFilter(ref KinectMSWrapper.NuiSkeletonData skeleton)
    {
        if (skeleton.eTrackingState != KinectMSWrapper.NuiSkeletonTrackingState.SkeletonTracked)
        {
            return;
        }
		...
		int jointsCount = (int)KinectMSWrapper.NuiSkeletonPositionIndex.Count;
    ...
    protected void FilterJoint(ref KinectMSWrapper.NuiSkeletonData skeleton, int jointIndex, ref KinectMSWrapper.NuiTransformSmoothParameters smoothingParameters)
    {
        float filteredState;
        float trend;
        float diffVal;
		...
		skeleton.eSkeletonPositionTrackingState[jointIndex] = (KinectMSWrapper.NuiSkeletonPositionTrackingState)(predictedState + 0.5f);
    }
