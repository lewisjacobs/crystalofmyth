...
public class RightHandMiddle : KinectGesture
{
    public RightHandMiddle()
    {
        this.ID = "Right Hand Middle";
        
        KinectAction rightArmMiddle = new KinectAction();
        rightArmMiddle.TimeOut = 1.0f;
        rightArmMiddle.PrimaryJoint = KinectMSWrapper.NuiSkeletonPositionIndex.HandRight;
