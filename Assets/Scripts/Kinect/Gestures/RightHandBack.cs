...
public class RightHandBack : KinectGesture 
{
    public RightHandBack()
    {
        this.ID = "Right Hand Back";
        
        KinectAction rightArmBack = new KinectAction();
        rightArmBack.TimeOut = 1.0f;
        rightArmBack.PrimaryJoint = KinectMSWrapper.NuiSkeletonPositionIndex.HandRight;
