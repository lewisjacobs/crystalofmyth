...
public class RightHandForward : KinectGesture
{
    public RightHandForward()
    {
        this.ID = "Right Hand Forward";
        
        KinectAction rightArmForward = new KinectAction();
        rightArmForward.TimeOut = 1.0f;
        rightArmForward.PrimaryJoint = KinectMSWrapper.NuiSkeletonPositionIndex.HandRight;
